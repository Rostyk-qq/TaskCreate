...
const RegistrationForm = () => {
    ...
    const [params, setParams] = useState({name: '', lastName: '', email: '', password: '', })
    return (
        <form>
            <input onChange={e => actionsCreators.CreatorName(e.target.value)} className="input" name='name' placeholder='Name' />
